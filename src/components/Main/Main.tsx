                        ...
                        <>
                            ...
                            <div className={s.blur_text}>
                                ...
                                <p className={s.text_p}>
                                    У нас вы можете подстричься, сделать маникюр на любой вкус,
                                    а так же приятно провести время с нашими специалистами.
                                </p>
                ...
                <div className={s.service__slider}>
                    ...
                    <div className={s.slider_line} style={{ right: offset + "px" }}>
                        <div className={s.slider1}>
                            ...
                            Стрижка в любом стиле с использованием профессиональных инструментов.
                            </p>
                        </div>
